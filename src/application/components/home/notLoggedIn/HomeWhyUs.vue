        ...
        <div class="container">
            <div class="d-flex flex-column flex-sm-row row justify-content-center">
                <div class="col-sm-6 col-md-4 mb-5">
                    <img src="@/assets/images/icons/Unlimited Access.svg" alt="" class="icons bg-gold" />
                    <h3 class="icon-title">Unlimited Access</h3>
                    <p class="icon-subtitle">One subscription, unlimited access.</p>
                </div>
                <div class="col-sm-6 col-md-4 mb-5">
                    <img src="@/assets/images/icons/Expert Teacher.svg" alt="" class="icons bg-gold" />
                ...
                <div class="col-sm-6 col-md-4 mb-5">
                    <img src="@/assets/images/icons/Study Anywhere.svg" alt="" class="icons bg-gold" />
                ...
                <div class="col-sm-6 col-md-4 mb-5">
                    <img src="@/assets/images/icons/Test Preps.svg" alt="" class="icons bg-gold" />
                ...
                <div class="col-sm-6 col-md-4 mb-5">
                    <img src="@/assets/images/icons/Post Questions.svg" alt="" class="icons bg-gold" />
