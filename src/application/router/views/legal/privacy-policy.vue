	...
	<Default>
		<div class="container py-3">
			...
			<p>At Stranerd, accessible from stranerd.com, one of our main priorities is the privacy of our visitors. This Privacy Policy document
				...
				they shared and/or collect in Stranerd. This policy is not applicable to any information collected offline or via channels other
				than this website. Our Privacy Policy was created with the help of the Privacy Policy Generator and the Generate Privacy
				Policy Generator.
			</p>
			<h2>Consent</h2>
			...
			<ul>
				...
				<li>Communicate with you, either directly or through one of our partners, including for customer service, to provide you with
					updates and other information relating to the webste, and for marketing and promotional purposes</li>
				<li>Send you emails</li>
				<li>Find and prevent fraud</li>
			</ul>
			<h2>Log Files</h2>
			<p>Stranerd follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies
			...
			<p>Like any other website, Stranerd uses 'cookies'. These cookies are used to store information including visitors' preferences,
			...
			<p>You may consult this list to find the Privacy Policy for each of the advertising partners of Stranerd.
				Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in their
				respective advertisements and links that appear on Stranerd, which are sent directly to users' browser. They automatically
				...
				9/3/2020 Privacy Policy
				https://www.privacypolicygenerator.info/live.php?token=QZkxestcvSYfdSWwjbSPPlHtOPmuJBHv 2/2
				Note that Stranerd has no access to or control over these cookies that are used by third-party advertisers.
			</p>
			<h2>Third Party Privacy Policies</h2>
			<p>Stranerd's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective
			...
			<p>Another part of our priority is adding protection for children while using the internet. We encourage parents and guardians to
				...
				Stranerd does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that
