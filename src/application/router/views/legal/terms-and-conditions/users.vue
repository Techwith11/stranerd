	...
	<Default>
		<div class="container py-3">
			...
			<p>Welcome to STRANERD!
				...
				to use STRANERD if you do not agree to take all of the terms and conditions stated on this
				page. Our Terms and Conditions were created with the help of the Terms And Conditions
			...
			<h3>Cookies</h3>
			<p>We employ the use of cookies. By accessing STRANERD, you agreed to use cookies in
				agreement with the STRANERD’s Privacy Policy.
			...
			<h3>License</h3>
			<p>Unless otherwise stated, STRANERD and/or its licensors own the intellectual property rights for
				all material on STRANERD. All intellectual property rights are reserved. You may access this
				from STRANERD for your own personal use subjected to restrictions set in these terms and
				conditions.
				You must not:
			</p>
			<ul>
				<li>Republish material from STRANERD</li>
				<li>Sell, rent or sub-license material from STRANERD</li>
				<li>Reproduce, duplicate or copy material from STRANERD</li>
				<li>Redistribute content from STRANERD</li>
			</ul>
			<p>This Agreement shall begin on the date hereof.
				...
				information in certain areas of the website. STRANERD does not filter, edit, publish or review
				Comments prior to their presence on the website. Comments do not reflect the views and
				opinions of STRANERD,its agents and/or affiliates. Comments reflect the views and opinions of
				the person who posts their views and opinions. To the extent permitted by applicable laws,
				STRANERD shall not be liable for the Comments or for any liability, damages or expenses
				caused and/or suffered as a result of any use of and/or posting of and/or appearance of the
				Comments on this website.
				STRANERD reserves the right to monitor all Comments and to remove any Comments which
			...
			<p>You hereby grant STRANERD a non-exclusive license to use, reproduce, edit and authorize
			...
			<ul>
				...
				<li>System wide Accredited Businesses except soliciting non-profit organizations, charity
					shopping malls, and charity fundraising groups which may not hyperlink to our Website</li>
			</ul>
			...
			<p>We will approve link requests from these organizations if we decide that: (a) the link would not
				...
				hyperlink compensates the absence of STRANERD; and (d) the link is in the context of general
				...
				our website, you must inform us by sending an email to STRANERD. Please include your name,
			...
			<p>No use of STRANERD’s logo or other artwork will be allowed for linking absent a trademark license agreement</p>
			<h3>iFrames</h3>
			<p>Without prior approval and written permission, you may not create frames around our Web
			...
			<p>The limitations and prohibitions of liability set in this Section and elsewhere in this disclaimer: (a)
				...
				As long as the website and the information and services on the website & payment charges are
				clearly stated, we will not be liable for any loss or damage of any nature.
			</p>
			<h3>Warranties Disclaimer</h3>
			<p>WE MAKE NO WARRANTIES AS TO OUR PROGRAMS, PRODUCTS, SERVICES, OR
				...
				CORRECTED, OR THAT ANY PART OF THE WEBSITE, CONTENT ARE FREE OF VIRUSES
				OR OTHER HARMFUL COMPONENTS. WE DO NOT WARRANT OR MAKE ANY
			...
			<h3>Technology Disclaimer</h3>
			<p>We make reasonable efforts to provide You with modern, reliable technology, software and
				...
				Google Drive, Zoom, Dreamhost, PayPal, or Stripe.
			</p>
			<h3>Errors and Omissions</h3>
			<p>We make no warranty or guarantee as to the accuracy, timeliness, performance, completeness
			...
			<p>You agree at all times to indemnify and hold harmless our Company, as well as any of our
			...
			<p>We will not be held responsible or liable in any way for the information, products or materials
			...
			<h3>Affiliates</h3>
			<p>This site may use affiliate links to sell certain products or services. We disclaim any and all
			...
			<h3>Termination</h3>
			<p>If at any time we feel you have violated these Terms and Conditions, then we shall immediately
				terminate your use of our website and any related communications as we deem appropriate. It
				is within our sole discretion to allow any user’s access to our website, and we may revoke this
				access at any time without notice, and if necessary, block your IP address from further visits to
				our site(s).
			</p>
			<h2>Financial Considerations</h2>
			<h3>Refunds</h3>
			<p>We take your investment seriously, and we’d appreciate it if you took our investment of time and
				resources into your success seriously too.
				Due to the nature of the services and/or products/materials provided, the maximum amount of
				money that may be refunded is only half of the payment made.
				For a refund to be valid, there must be substantial proof of failure/negligence/carelessness of
				our products or services. Failure to provide such evidence would render any claim for refund
				invalid.
			</p>
		</div>
	</Default>
