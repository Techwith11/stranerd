		...
		data: () => ({
			course: {
				...
				author: {
					id:1,
					name: 'Timmy Salami',
					description: 'Timmy Salami is a senior educational evangelist based in Lagos, Nigeria. He has 3 PhDs in fields ranging from Applied Mathematics to Electrical and Electronic engineering.'
				},
				documents: [
